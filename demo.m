...
mu = [0.31481705136223537, 0.09893200177528344, 0.0, 1.0, 0.10870299600999056, 0.14059990074956819, 0.05960331421619233, 0.1144995308444295, 0.15954257654603815]; game = gameBernoulli(mu); fname = 'results/2abis';
% Choice of policies to be run
policies = {policyThompson(), policyUCB(), policyUCBtuned(), policyUCBV(), policyMOSS()};
